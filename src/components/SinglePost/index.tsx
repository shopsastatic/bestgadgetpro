...
const SingleContent: FC<SingleContentProps> = ({ post }) => {
                        ...
                        cells.forEach((cell, cellIndex) => {
                            ...
                            if (cell.innerHTML) {
                                const icon = cellIndex === 0
                                    ...
                                    : '<svg width="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M5.62252 7.17879L7.41279 5.38672L18.7265 16.7004L16.8 18.5995L5.62252 7.17879Z" fill="#D71919"></path><path fillRule="evenodd" clipRule="evenodd" d="M16.9344 5.50932L18.7265 7.29959L7.41281 18.6133L5.51375 16.6868L16.9344 5.50932Z" fill="#D71919"></path></svg>';
    ...
    const renderRating = (rating: any, index: any) => {
        ...
        return (
            <div key={`rating-${index}`} className="stars" style={{ display: 'flex', alignItems: 'center', marginTop: '3px' }}>
                {[...Array(5)].map((_, i) => {
                    const starKey = `star-${index}-${i}`;

                    if (rating >= i + 1) {
                        return <span key={starKey}>{renderStar(true)}</span>;
                    } else if (rating > i && rating < i + 1) {
                        const partial = rating - i;
                        return <span key={starKey}>{renderStar(false, partial)}</span>;
                    } else {
                        return <span key={starKey}>{renderStar(false)}</span>;
                    }
                })}
            </div>
        );
                                ...
                                <a href={item?.url || "/"} target="_blank" className={`prod-child prod-item-${++counter} cursor-pointer grid grid-cols-1 md:grid-cols-10 bg-white rounded-2xl gap-x-3 md:gap-x-7 px-4 md:px-0`}>
                                                        ...
                                                        <div className="grid gap-4">
                                                            {item.cusDescContent1 && (
                                                                <div className="main-highlight-item col-span-1 flex items-start gap-2 border-b border-[#e2e2e2] pb-4">
                                                                    <div>
                                                                        <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 512 512" fillRule="evenodd" width="20" height="24" viewBox="0 0 32 32">
                                                            ...
                                                            {item.cusDescContent2 && (
                                                                <div className="main-highlight-item col-span-1 flex items-start gap-2 border-b border-[#e2e2e2] pb-4">
                                                                    <div>
                                                                        <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 512 512" fillRule="evenodd" width="24" height="24" viewBox="0 0 32 32">
                                                            ...
                                                            {item.cusDescContent3 && (
                                                                <div className="main-highlight-item col-span-1 flex items-start gap-2 border-b border-[#e2e2e2] pb-4">
                                                                    <div>
                                                                        <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 512 512" fillRule="evenodd" width="22" height="22" viewBox="0 0 32 32">
                                    ...
                                    <div className="col-span-1 md:col-span-3 flex flex-col sec-3 items-center pr-0 md:pr-5 mb-2 justify-between">
                                        <div className="heading-poligon">
                                            ...
                                            {renderRating(calculateRating(counter)[1], index)}
                                        </div>
